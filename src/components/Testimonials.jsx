    ...
    <div>
      <div className="container my-24 px-6 mx-auto">
        <section className="mb-32 text-gray-800 text-center">
          <h2 className="text-3xl font-bold mb-12 uppercase text-error">Testimonials</h2>
          ...
          <div className="grid md:grid-cols-3 gap-x-6 lg:gap-x-12">
            <div className="mb-12 md:mb-0">
              ...
              <h6 className="font-medium text-blue-600 mb-4">Teacher</h6>
              <p className="mb-4">
                <svg
                  aria-hidden="true"
                  focusable="false"
            ...
            <div className="mb-12 md:mb-0">
              ...
              <h6 className="font-medium text-blue-600 mb-4">Housewife</h6>
              <p className="mb-4">
                <svg
                  aria-hidden="true"
                  focusable="false"
            ...
            <div className="mb-0">
              ...
              <h6 className="font-medium text-blue-600 mb-4">Business man</h6>
              <p className="mb-4">
                <svg
                  aria-hidden="true"
                  focusable="false"
